 ...
 *
 * Copyright (C) 2013 Christian Vogelgsang, M5Stack, MeemeeLab
...
FBTFT_REGISTER_SPI_DRIVER(DRVNAME, "ilitek", "ili9342c", &display);
...
MODULE_AUTHOR("Christian Vogelgsang, M5Stack, MeemeeLab");
MODULE_LICENSE("GPL");
